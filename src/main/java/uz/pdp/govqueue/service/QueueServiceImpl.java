...
public class QueueServiceImpl implements QueueService {
    ...
    @Override
    public ApiResult<List<StatusDTO>> forBoard() {

        Integer operatorId = CommonUtils.getCurrentUserFromContext().getOperatorId();
    ...
    @Override
    public ApiResult<QueueDTO> callQueue() {


        Integer operatorId = CommonUtils.getCurrentUserFromContext().getOperator().getId();
